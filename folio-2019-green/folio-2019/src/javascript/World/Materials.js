...
export default class Materials
{
    ...
    setShades()
    {
        ...
        this.shades = {}
        this.shades.items = {}
        this.shades.indirectColor = '#1a6b2a'
        ...
        // Beige → remplacé par vert pour les arbres (cité universitaire agricole)
        this.shades.items.beige = new MatcapMaterial()
        this.shades.items.beige.name = 'shadeBeige'
        this.shades.items.beige.uniforms.matcap.value = this.resources.items.matcapGreenTexture
        ...
        // Yellow → remplacé par emerald green (arbres agriculture)
        this.shades.items.yellow = new MatcapMaterial()
        this.shades.items.yellow.name = 'shadeYellow'
        this.shades.items.yellow.uniforms.matcap.value = this.resources.items.matcapEmeraldGreenTexture
        ...
        // Agriculture
        this.shades.items.agriculture = new MatcapMaterial()
        this.shades.items.agriculture.name = 'shadeAgriculture'
        this.shades.items.agriculture.uniforms.matcap.value = this.resources.items.matcapAgricultureTexture
        this.items.agriculture = this.shades.items.agriculture
    ...
    setFloorShadow()
    {
        ...
        this.items.floorShadow.shadowColor = '#1a6b2a'
